	...
	for(i=0; i<window.regions.length; i++)
	{
		...
		switch(currentZoom)
		{
			case(1):
				...
				// console.log("This region is: " + window.regions[i].name + "and it's dimensions at zoom " + (currentZoom - 1) + " are " + d + ", " + );
				// window.regions[i].pin.style.left = window.regions[i].dimensions[currentZoom-1][0] + "px";
				// window.regions[i].pin.style.top = window.regions[i].dimensions[currentZoom-1][1] + "px";
				window.regions[i].pin.style.left = ((window.regions[i].coordinatePlot[(currentZoom-1)][0]) - 5) + "px";
				window.regions[i].pin.style.top = ((window.regions[i].coordinatePlot[(currentZoom-1)][1]) - 30) + "px";
			break;
			case(2):
				console.log("Zoom 2");
				window.regions[i].regionDOM.src = window.regions[i].fileToDraw1;
		...
		window.regions[i].regionDOM.style.minWidth = window.regions[i].dimensions[currentZoom-1][0];
		window.regions[i].regionDOM.style.minHeight = window.regions[i].dimensions[currentZoom-1][1];
	}
