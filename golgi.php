...
if (isset($_COOKIE['UID'])) 
{
	if($_COOKIE['UID'] != "")
	{
	    ...
	    $grav_url = "http://www.gravatar.com/avatar/" . md5( strtolower( trim( $identityEmail ) ) ) . "?d=" . urlencode( $default ) . "&s=25";
	}
	else
	{
		$identity = false;	
				...
				<div id="headerBar">
					...
					<div id="searchResultsDiv">
						...
						<div id="searchResultsCard2">
							...
							<div id="searchMyNotebook">
								<textarea id="searchMyNotebookNew" class="form-control" type="text" <?php if(!($identity)){echo 'style="display:none;"';}?>></textarea>
								<button id="searchMyNotebookNewBtn" class="btn btn-success btn-xs" onclick="searchSaveNote()" <?php if(!($identity)){echo 'style="display:none;"';}?>>Save</button>
								<div id="searchMyNotebookFlex">
								</div>
							</div>
						</div>
					</div>
					...
					<div id="userDiv">
						...
						<?php 
							...
							{
								echo '<div style="padding-top:4px;"><span class="glyphicon glyphicon-user" style="padding-right:10px;"></span><a style="cursor:pointer" onclick="showCredentials()">Log in or sign up free</a></div>';
							}
						?>
		    ...
		    <div class="modal-content" style="height:600px;">
		      ...
		      <div class="modal-body">
		      	...
		      	<div id="regionCnxDetailNotes">
		      		<div id="regionCnxDetailNotesMyNotesLabel">
		      			<b>
							My Notebook:
						</b>
					</div>
					<div id="regionCnxDetailNotesMyNotebook">
						<textarea id="regionCnxDetailNotesMyNotebookNew" class="form-control" type="text" <?php if(!($identity)){echo 'style="display:none;"';}?>></textarea>
						<button id="regionCnxDetailNotesMyNotebookNewBtn" class="btn btn-success btn-xs" onclick="regionCnxDetailNotesSaveNote()" <?php if(!($identity)){echo 'style="display:none;"';}?>>Save</button>
						
						<div id="regionCnxDetailNotesMyNotebookFlex">
						</div>
					</div>
		      	</div>
		      </div>
		    ...
		    <div class="modal-content" style="height:600px;">
		      ...
		      <div class="modal-body">
		      	...
		      	<div id="regionMolsDetailNotes">
		      		<div id="regionMolsDetailNotesMyNotesLabel">
		      			<b>
							My Notebook:
						</b>
					</div>
					<div id="regionMolsDetailNotesMyNotebook">
						<textarea id="regionMolsDetailNotesMyNotebookNew" class="form-control" type="text" <?php if(!($identity)){echo 'style="display:none;"';}?>></textarea>
						<button id="regionMolsDetailNotesMyNotebookNewBtn" class="btn btn-success btn-xs" onclick="regionMolsDetailNotesSaveNote()" <?php if(!($identity)){echo 'style="display:none;"';}?>>Save</button>
						
						<div id="regionMolsDetailNotesMyNotebookFlex">
						</div>
					</div>
		      	</div>
		      </div>
		    ...
		    <div class="modal-content" style="height:600px;">
		      ...
		      <div class="modal-body">
		      	...
		      	<div id="regionCellsDetailNotes">
		      		<div id="regionCellsDetailNotesMyNotesLabel">
		      			<b>
							My Notebook:
						</b>
					</div>
					<div id="regionCellsDetailNotesMyNotebook">
						<textarea id="regionCellsDetailNotesMyNotebookNew" class="form-control" type="text" <?php if(!($identity)){echo 'style="display:none;"';}?>></textarea>
						<button id="regionCellsDetailNotesMyNotebookNewBtn" class="btn btn-success btn-xs" onclick="regionCellsDetailNotesSaveNote()" <?php if(!($identity)){echo 'style="display:none;"';}?>>Save</button>
						<div id="regionCellsDetailNotesMyNotebookFlex">
						</div>
					</div>
		      	</div>
		      </div>
