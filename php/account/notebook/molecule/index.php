<?php
	...
	if(isset($_COOKIE['UID']))
	{
		if($_COOKIE['UID'] != "")
		{
			...
			if(mysql_query("INSERT INTO `usegol5_flat`.`note` (`id`, `UID`, `itemType`, `itemID`, `note`, `dateTime`) VALUES (NULL, $UID, 3, $itemID, '" . $note . "', NOW())")or die("A MySQL error has occurred.<br />Your Query: " . $your_query . "<br /> Error: (" . mysql_errno() . ") " . mysql_error()))
			{
